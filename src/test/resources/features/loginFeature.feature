Feature: Login to at and capture error message for failure
  ...
  @New
  Scenario: Login to at in chrome browser with valid login credentials to check the transactions
    Given I'm on login screen of at using "chrome"
    When I enter username "sreerjvs@gmail.co", password "R@vijaya7" and submit
